...
instance EmbPrj Defn where
  ...
  icod_ (Function    a b s t (_:_) c d e f g h i j k m n) = __IMPOSSIBLE__
  icod_ (Function    a b s t []    c d e f g h i j k m n) =
    icodeN 1 (\ a b s -> Function a b s t []) a b s c d e f g h i j k m n
  ...
  value = vcase valu where
    ...
    valu [1, a, b, s, c, d, e, f, g, h, i, j, k, m, n] = valuN (\ a b s -> Function a b s Nothing []) a b s c d e f g h i j k m n
